...
let carreras = [{
    ...
    HorariosH: "./files/HorariosHomogeneas.pdf",
    Horarios: "./files/CIVIL/HorariosCivil.pdf",
    CORRELATIVIDADESYEQUIVALENCIAS: "./files/CIVIL/Correlatividades%20y%20equivalencias.pdf",
    DISEÑOCURRICULAR: "./files/CIVIL/dis.pdf",
    FAQ: "./files/CIVIL/FAQ.docx",
    IMPLEMENTACION: "./files/CIVIL/Implementacion.pdf",
    PLANESDEESTUDIO: "./files/CIVIL/plan.pdf",
    ...
    FAQ: "./files/ELECTRICA/FAQ.docx",
    IMPLEMENTACION: "./files/ELECTRICA/Implementacion.pdf",
    PLANESDEESTUDIO: "./files/ELECTRICA/plan.pdf",
    ...
    FAQ: "./files/ELECTRONICA/FAQ.docx",
    IMPLEMENTACION: "./files/ELECTRONICA/Implementacion.pdf",
    PLANESDEESTUDIO: "./files/ELECTRONICA/plan.pdf",
    ...
    HorariosH: "./files/HorariosHomogeneas.pdf", Horarios: "./files/ELECTRONICA/HorariosElectronica.pdf",
    CORRELATIVIDADESYEQUIVALENCIAS: "PROXIMAMENTE",
    DISEÑOCURRICULAR: "PROXIMAMENTE",
    FAQ: "PROXIMAMENTE",
    IMPLEMENTACION: "PROXIMAMENTE",
    HorariosH: "./files/HorariosHomogeneas.pdf",
    Horarios: "./files/INDUSTRIAL/HorariosIndustrial.pdf",
    PLANESDEESTUDIO: "./files/INDUSTRIAL/plan.pdf",
    ...
    HorariosH: "./files/HorariosHomogeneas.pdf", Horarios: "./files/MECANICA/HorariosMecanica.pdf",
    CORRELATIVIDADESYEQUIVALENCIAS: "./files/MECANICA/Correlatividades%20y%20equivalencias.pdf",
    DISEÑOCURRICULAR: "./files/MECANICA/dis.pdf",
    FAQ: "./files/MECANICA/FAQ.docx",
    IMPLEMENTACION: "./files/CIVIL/Implementacion.pdf",
    PLANESDEESTUDIO: "./files/MECANICA/plan.pdf",
    ...
    HorariosH: "./files/HorariosHomogeneas.pdf", Horarios: "./files/QUIMICA/HorariosQuimica.pdf",
    CORRELATIVIDADESYEQUIVALENCIAS: "./files/QUIMICA/Correlatividades%20y%20equivalencias.pdf",
    DISEÑOCURRICULAR: "./files/QUIMICA/dis.pdf",
    FAQ: "./files/QUIMICA/FAQ.docx",
    IMPLEMENTACION: "./files/QUIMICA/Implementacion.pdf",
    PLANESDEESTUDIO: "./files/QUIMICA/plan.docx",
